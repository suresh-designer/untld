...
function useItemStore() {
    ...
    const fetchData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            const [foldersRes, itemsRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(FOLDERS_TABLE).select('*').order('created_at', {
                    ascending: true
                }),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(ITEMS_TABLE).select('*').order('created_at', {
                    ascending: false
                })
            ]);
            ...
            const loadedFolders = (foldersRes.data || []).map((f)=>({
                    id: f.id,
                    name: f.name,
                    color: f.color,
            ...
            if (loadedFolders.length === 0) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(FOLDERS_TABLE).insert({
                    id: defaultFolder.id,
    ...
    const deleteFolder = async (id)=>{
        ...
        await Promise.all([
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(FOLDERS_TABLE).delete().eq('id', id)
        ]);
    };
    const addItem = async (item)=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(ITEMS_TABLE).insert({
            id: newItem.id,
            type: newItem.type,
    ...
    const updateItem = async (id, updates)=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(ITEMS_TABLE).update(dbUpdates).eq('id', id);
    };
    const deleteItem = async (id)=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(ITEMS_TABLE).delete().eq('id', id);
    };
...
;
function Home() {
    const { folders, items, isLoaded, addFolder, renameFolder, updateFolderColor, deleteFolder, addItem, updateItem, deleteItem, getGroupedItems, DEFAULT_FOLDER_ID, totalCount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$item$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useItemStore"])();
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("text-[11px] font-mono font-bold", totalCount >= 100 ? "text-destructive" : "text-foreground"),
                                            children: [
                                                totalCount,
                                                "/100"
                                            ]
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c5f7584._.js.map